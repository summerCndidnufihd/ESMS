...
<div class="page-container" style="margin-left:35%">
     <form action="countBookSubmitServlet" method="post">
     <select name="count_item">
       <option value="book_author">作者</option>
       <option value="book_type">类别</option>
       <option value="book_publish">出版社</option>
     </select>
		<button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont"></i>统计</button>
     </form>
</div>
